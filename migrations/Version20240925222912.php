 ...
 */
final class Version20240925222912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id_commande INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, etat_commande_id INT NOT NULL, date_commande DATE NOT NULL, total NUMERIC(10, 2) NOT NULL, transporteur VARCHAR(100) NOT NULL, poids NUMERIC(10, 2) NOT NULL, frais_livraison NUMERIC(10, 2) NOT NULL, numero_suivi VARCHAR(100) NOT NULL, reference VARCHAR(13) NOT NULL, INDEX idx_utilisateur_id (utilisateur_id), INDEX idx_etat_commande_id (etat_commande_id), INDEX idx_date_commande (date_commande), PRIMARY KEY(id_commande)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id_produit INT AUTO_INCREMENT NOT NULL, tva_id INT NOT NULL, reference VARCHAR(32) NOT NULL, nom VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, prix NUMERIC(10, 2) NOT NULL, INDEX IDX_29A5EC274D79775F (tva_id), INDEX idx_nom (nom), INDEX idx_prix (prix), UNIQUE INDEX uq_reference (reference), PRIMARY KEY(id_produit)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id_utilisateur INT AUTO_INCREMENT NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL, telephone VARCHAR(10) DEFAULT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(20) NOT NULL, token_reinitialisation VARCHAR(255) DEFAULT NULL, email_valide TINYINT(1) DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), INDEX idx_role (role), PRIMARY KEY(id_utilisateur)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
