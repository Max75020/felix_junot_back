 ...
 */
final class Version20241021094938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id_produit INT AUTO_INCREMENT NOT NULL, tva_id INT NOT NULL, reference VARCHAR(15) NOT NULL, nom VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, prix_ht NUMERIC(10, 2) NOT NULL, prix_ttc NUMERIC(10, 2) NOT NULL, stock INT NOT NULL, INDEX idx_nom (nom), INDEX idx_prix (prix_ttc), INDEX idx_tva (tva_id), UNIQUE INDEX uq_reference (reference), PRIMARY KEY(id_produit)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
