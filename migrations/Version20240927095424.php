 ...
 */
final class Version20240927095424 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adresse (id_adresse INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, type VARCHAR(20) NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, rue VARCHAR(255) NOT NULL, batiment VARCHAR(100) DEFAULT NULL, appartement VARCHAR(100) DEFAULT NULL, code_postal VARCHAR(5) NOT NULL, ville VARCHAR(100) NOT NULL, pays VARCHAR(50) NOT NULL, telephone VARCHAR(14) DEFAULT NULL, similaire TINYINT(1) DEFAULT 0 NOT NULL, INDEX idx_utilisateur_id (utilisateur_id), PRIMARY KEY(id_adresse)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categorie (id_categorie INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_497DD6346C6E55B5 (nom), PRIMARY KEY(id_categorie)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande (id_commande INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, etat_commande_id INT NOT NULL, date_commande DATE NOT NULL, total NUMERIC(10, 2) NOT NULL, transporteur VARCHAR(100) NOT NULL, poids NUMERIC(10, 2) NOT NULL, frais_livraison NUMERIC(10, 2) NOT NULL, numero_suivi VARCHAR(100) NOT NULL, reference VARCHAR(30) NOT NULL, INDEX idx_utilisateur_id (utilisateur_id), INDEX idx_etat_commande_id (etat_commande_id), INDEX idx_date_commande (date_commande), PRIMARY KEY(id_commande)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande_produit (id_commande_produit INT AUTO_INCREMENT NOT NULL, commande_id INT NOT NULL, produit_id INT NOT NULL, quantite INT NOT NULL, INDEX idx_commande_id (commande_id), INDEX idx_produit_id (produit_id), PRIMARY KEY(id_commande_produit)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE historique_etat_commande (id_historique_etat_commande INT AUTO_INCREMENT NOT NULL, commande_id INT NOT NULL, etat_commande_id INT NOT NULL, date_etat DATE NOT NULL, INDEX idx_commande_id (commande_id), INDEX idx_etat_commande_id (etat_commande_id), INDEX idx_date_etat (date_etat), PRIMARY KEY(id_historique_etat_commande)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE panier (id_panier INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, INDEX idx_utilisateur_id (utilisateur_id), PRIMARY KEY(id_panier)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE panier_produit (id_panier_produit INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, panier_id INT NOT NULL, quantite INT NOT NULL, INDEX idx_panier_id (panier_id), INDEX idx_produit_id (produit_id), PRIMARY KEY(id_panier_produit)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit (id_produit INT AUTO_INCREMENT NOT NULL, tva_id INT NOT NULL, reference VARCHAR(15) NOT NULL, nom VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, prix NUMERIC(10, 2) NOT NULL, INDEX IDX_29A5EC274D79775F (tva_id), INDEX idx_nom (nom), INDEX idx_prix (prix), UNIQUE INDEX uq_reference (reference), PRIMARY KEY(id_produit)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tva (id_tva INT AUTO_INCREMENT NOT NULL, taux NUMERIC(4, 2) NOT NULL, INDEX idx_taux (taux), PRIMARY KEY(id_tva)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateur (id_utilisateur INT AUTO_INCREMENT NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL, telephone VARCHAR(14) DEFAULT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(20) NOT NULL, token_reinitialisation VARCHAR(255) DEFAULT NULL, email_valide TINYINT(1) DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), INDEX idx_role (role), PRIMARY KEY(id_utilisateur)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
