...
{
	/**
	 * Scénario 1 : Vérifie que lorsque l'utilisateur crée une commande, 
	...
	/**
	 * Scénario 2 : Vérifie qu'un utilisateur standard n'a pas les permissions pour créer un historique d'état de commande.
	...
	/**
	 * Scénario 3 : Vérifie qu'un administrateur peut créer un historique d'état de commande, puis le récupérer via l'API.
	 */
